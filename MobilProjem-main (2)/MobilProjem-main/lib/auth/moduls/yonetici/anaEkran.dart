    ...
    try {
      ...
      String? rezervasyonOnayi = await showDialog<String>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Text("$saat saatine rezervasyon yapmak istediğinize emin misiniz?"),
          actions: [
            TextButton(
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: dolu ? null : () => rezervasyonYap(saatId, rezervasyon['saat']),
                      child: Container(
                        decoration: BoxDecoration(
                          color: dolu ? Colors.red.shade100 : Colors.green.shade100,
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              if (dolu && rezervasyon['rezervasyonSahibiBilgileri']?['isim']?.isNotEmpty)
                                Text(
                                  rezervasyon['rezervasyonSahibiBilgileri']['isim'],
