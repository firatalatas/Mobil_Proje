...
class _AdminAnaEkranState extends State<AdminAnaEkran> {
  ...
  Future<void> _rezervasyonIptal(String saatId, Map<String, dynamic> rezervasyon) async {
    ...
    final onay = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('${rezervasyon['saat']} saatindeki rezervasyonu iptal etmek istediğinize emin misiniz?'),
            const SizedBox(height: 8),
            Text('Rezervasyon Sahibi: ${rezervasyon['rezervasyonSahibiBilgileri']['isim']}'),
          ],
        ),
        actions: [
          TextButton(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text('E-posta: ${rezervasyon['rezervasyonSahibiBilgileri']['email']}'),
            const SizedBox(height: 8),
            Text('Telefon: ${rezervasyon['rezervasyonSahibiBilgileri']['telefon']}'),
            const SizedBox(height: 8),
                            ...
                            ? Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () => _rezervasyonDetayGoster(rezervasyon),
                                  ),
                                  IconButton(
                                    ...
                                    onPressed: _isLoading
                                        ? null
                                        : () => _rezervasyonIptal(saatId, rezervasyon),
                                  ),
                                ],
                              )
                            : null,
